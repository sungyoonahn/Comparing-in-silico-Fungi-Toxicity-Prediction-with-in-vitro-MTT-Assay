...
main_train_csv_folder_path = "datasets/HMP_Swissprot_0430/"
main_output_save_folder_path = "results/HMP_Swissprot_0524_batch0_3600/"
...
if __name__ == "__main__":
    ...
    main_inference_path = "results/HMP_Swissprot_0528_batch1_5200/"
    if args.fine_tune == True:
        print("Fine Tune Model")
        print("Loading Best Weights ... ")
        # enter the path to use
        best_weights_path = main_inference_path+"best_weights.pth"
        # best_weights_path = "results/HMP_Swissprot_0525_batch0_4400/best_weights.pth"
    ...
    if args.mode == "inference":
        ...
        save_dir = main_inference_path+"tremble_batch_results/"
        # save_dir = main_inference_path
        ...
        infer_loader = DataLoader(infer_dataset, batch_size=args.batch_size, shuffle=False, collate_fn=collate_fn, num_workers=4)
