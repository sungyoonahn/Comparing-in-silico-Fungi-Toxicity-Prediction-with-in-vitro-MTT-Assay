...
# # Load sequences
# salmonela_df = pd.read_csv("results/bacteria_inference/Salmonella_typhimurium_(strainLT2)1029.csv")
...
#     with open(f"results/attention_visualized/{class_name}/matched_sequences_{class_name}_1213_clus_10.fasta", "w") as f:
...
# fasta_sequences = SeqIO.parse(open(f"results/attention_visualized/{class_name}/matched_sequences_{class_name}_1213_clus_10.fasta"), 'fasta')
...
# matched_df.to_csv(f"results/attention_visualized/{class_name}/matched_sequences_{class_name}_1213_clus_10.csv", index=False)