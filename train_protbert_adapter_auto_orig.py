...
def sample_trainable_df_5class(df, sample_count):
    ...
    if len(secretion_df)>=sample_count:
        secretion_random_df = secretion_df.sample(sample_count)
        empty_class_dict["secretion"] = len(secretion_random_df)
    else:
...
if __name__ == "__main__":
    ...
    for i in range(num_runs):
        ...
        main_train_csv_folder_path = "datasets/HMP_Swissprot_"+date+"_"+str(num_per_class)+"/"
        main_output_save_folder_path = "results/HMP_Swissprot_"+date+"_"+str(num_per_class)+"/"
        ...
        infer_df = pd.read_csv("datasets/TREMBL(UNIPROT)/Bacteria/batch_data/batch_0_to_6_all_5class.csv")
        ...
        save_new_pth = "datasets/HMP_Swissprot_"+date+"_"+str(num_per_class)+"/"
        results_save_new_pth = "results/HMP_Swissprot_"+date+"_"+str(num_per_class)+"/"
