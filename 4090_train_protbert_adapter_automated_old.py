...
if __name__ == "__main__":
    ...
    for i in range(num_runs):
        ...
        infer_df = pd.read_csv("datasets/TremBLE(UNIPROT)/Bacteria/batch_data/batch_1_5class_only_virulence_toxin_anti_toxin_secretion.csv")
        ...
        print(infer_results)
        infer_results.to_csv(save_dir + "batch_1_5class_only_virulence_toxin_anti_toxin_secretion.csv", index=False)
        ...
        df_new.to_csv(preds_save_pth+"batch_1_5class_only_virulence_toxin_anti_toxin_secretion.csv", index=False)
        df = pd.read_csv(preds_save_pth+"batch_1_5class_only_virulence_toxin_anti_toxin_secretion.csv")
        # print(df)
        ...
        df_1.to_csv(preds_save_pth+"batch_1_5class_only_virulence_toxin_anti_toxin_secretion.csv", index=False)
        
        df_preds_matching = pd.read_csv(preds_save_pth+"batch_1_5class_only_virulence_toxin_anti_toxin_secretion.csv")
