...
parser.add_argument('--datasets_dir', '-d', default="datasets_swissprot/", help='input dir', type=str)
parser.add_argument('--results_dir', '-r', default="results_swissprot/", help='output dir', type=str)
...
if __name__ == "__main__":
    ...
    for i in range(num_runs):
        ...
        main_train_csv_folder_path = args.datasets_dir
        main_output_save_folder_path = args.results_dir
